...
// Кнопки управления сигналом
#define BUTTON_PORT  PORTC
#define BUTTON_PIN   PINC
#define BUTTON_DDR   DDRC
#define BUTTON_HORN_MASK (1<<PC0)
#define BUTTON_SOUND1_MASK (1<<PC1)
#define BUTTON_SOUND2_MASK (1<<PC2)
#define BUTTON_MODE_MASK (1<<PC3)
#define BUTTON_MASK  (BUTTON_MODE_MASK | BUTTON_HORN_MASK | BUTTON_SOUND1_MASK | BUTTON_SOUND2_MASK)
