...
Purpose:  Disable UART transmitter, receive and corresponding interrupts
Input:    none
Returns:  none
**************************************************************************/
void uart_disable() 
{
	#if defined( AT90_UART )
		/* Disable UART receiver and transmitter and receive complete interrupt */
		UART0_CONTROL &= ~(_BV(RXCIE)|_BV(RXEN)|_BV(TXEN));

	#elif defined (ATMEGA_USART)
		/* Disable USART receiver and transmitter and receive complete interrupt */
